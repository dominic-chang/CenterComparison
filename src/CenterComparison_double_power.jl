...
lower_bound = (rad = 8.0, p1 = 1.0, p2 = 0.1, ell = 0.0, x = -10.0, y = -10.0)

#upper bounds on parameters
upper_bound = (rad = 50.0, p1 = 100.0, p2 = 100.0, ell = 1.0, x = 10.0, y = 10.0)
...
xopt, opt_temp, divmin =
    vida(prob, OBBO.BBO_adaptive_de_rand_1_bin(); maxiters = 100_000, callback = callback) #run problem 
